	...
	<div class="cell">
		<section class="splash-prose" style="max-width: 680px; width: 100%;">
			...
			<div class="text-center">
				<a href="" class="button" style="background: #E9E9E9;border: 4px solid #D59F53;border-radius: 12px;font-size: 36px;letter-spacing: 1px; color: #000;"><strong>RSVP</strong></a>
			</div>
		</section>
	</div>
</div>
